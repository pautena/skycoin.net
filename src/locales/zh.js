export default {
  ...
  home: {
    ...
    hero: {
      heading: '新世界的新互联网',
      paragraph: '天空链平台是世界上最先进的区块链应用生态系统。由比特币和以太坊的早期贡献者开发，天空链的平台是完全安全的，可无限扩展的，并独立于ISP。以带宽，存储和计算能力为后盾天空链旨在实现中本聪（Satoshi Nakamoto）的愿景初衷',
      buy: '购买天空链',
      wallet: {
        get: '下载钱包',
      },
    ...
    press: {
      ...
      body: '“网络中立性和消费者数据隐私成为2017年技术的两大关键问题。如果您担心为互联网服务提供商给的不可靠覆盖率买巨单，还冒着数据被出售，政府监控和审查等风险，所有这些核心问题，让天空链来解决。“',
    },
    ecosystem: {
      ...
      coinHours: {
        title: '币时',
        text: '通过持有天空链，币时成为天空链平台上服务的支付机制。',
      },
      coinJoin: {
        title: 'Coin Join',
      ...
      nodes: {
        title: '节点',
        text: 'Skywire网络的构建模块，可由任何人部署以确保Skywire生态系统的去中心化化。',
      },
      cx: {
        title: 'CX',
        text: '一种定制的编程语言，是在Golang之上开发的。旨在易于学习和快速实施。',
      },
      cxo: {
        title: 'CXO',
    ...
    signup: {
      heading: '加入我们的Skyfleet新闻快讯并通过天空链腾飞至新的高度！',
      body: '保持更新，接收天空链团队的最新消息，并通过订阅我们的新闻通讯共同进步！输入您的个人电子邮件地址，让我们带你飞。',
      button: '注册',
    },
  },
  downloads: {
    ...
    bbs: {
      heading: '下载天空链 BBS',
      lead: '天空链 BBS使用Fiber-天空链的blockhain技术构建的下一代去中心化式社交网络',
      githublink: '在Github上查找最新的二进制文件',
      thinclient: '访问BBS轻量级客户机环境',
    },
    whitepapers: {
  ...
  ecosystem: {
    ...
    skycoin: {
      heading: '天空链',
      body: '创建天空链是为了解决比特币和以太坊的缺点。当务之急出于必要，当时还没有其他币种实现了中本聪最初的完全去中心化数字货币的愿景。<br/><br/>通过其专有的Obelisk共识算法，天空链的平台不受集中和操作的限制。它具有CX，一种完全基于图灵完备的编程语言，允许成千上万的开发人员轻松地将应用程序部署到区块链。 天空链具有几乎免费交易的货币功能，即将实施的绝对隐私功能以及类似Visa的支付处理系统的速度，是固有的资产支持价值而不基于投机。<br/><br/>持有天空链产生的币时用于在Skywire网络上购买服务，并且可以兑换更多的天空链</p>',
    },
    skywire: {
      heading: 'Skywire',
      body: '神速：它不会受到大型ISP的限制和其他服务中断的影响。<br/><br/>隐私：这意味着您在浏览时无法跟踪。 Skywire社区不会每月支付巨额来跟踪ISP（并且在未经许可的情况下出售您的浏览数据），而是通过互联网服务来保护他们的隐私。<br/><br/>奖励：Skywire将开发无线网状网络（WMN）。用户可以同时获得天空链和币时，来运行为整个网络提供带宽和存储的硬件节点。用户还可以根据自己的选择在内容和其他网络资源上花费赚取的投币时间。<br/><br/>安全：Skywire由用户自己创建。用户在网络上做出的决定，网络运行在信任系统网络上，通过社区的集体协议，恶意节点将从主Skywire网络中断。这个共识模型让Skywire免于攻击，开发和操纵。<br/><br/>在一个以利润为名的时代消费者一直被大公司利用，天空链的Skywire网络让人耳目一新。 Skywire将权力赋予人民，并在此过程中创建更强大，更快速，更安全的互联网。</p>',
  ...
  skyminer: {
    ...
    about: {
      heading: '探索天空矿机',
      subheading: 'Skywire 矿机：下一代互联网硬件',
      paragraph1: '作为“节点”为新型互联网提供主干网，Skywire矿机经过精心设计和配置，成为下一代互联网提供支柱。其定制硬件超越技术规格实现提供最大功率和性能。 Skywire作为Skycoin的矿机也能充当专用VPN，它使用以下硬件配置：',
      paragraph2: '每块主板单独配有ARM处理器，2 GB RAM和32GB-256 GB之间任意大小的闪存。硬件被分割的方式使得即使一个服务受到损害，同一台计算机上的其他服务还能正常运转。具有严格数据包转发规则和访问控制的OpenWRT路由器可提高安全性。该设置可以定制成4,8,16或32个主板。',
      paragraph3: '在Skywire网络上运行的节点将会接收到除流量转发之外的网络激励以帮助建立网络。对Skywire矿机而言，我们希望增加这种网络激励奖励。但我们仍在研究一种机制，来区分Skywire矿机与网络上任何机器上其他不同类型节点。',
      list: {
        item0: '8个CPU板',
        item1: '每块电路板2 GB RAM',
        item2: '每块电路板有4个CPU核心',
        item3: '每块电路板64 GB的存储空间',
        item4: '64位Linux（Alpine Linux）',
